...
internal class ScaleGestureDetectorKotlin(private val mListener: OnScaleGestureListener) {
    ...
    internal interface OnScaleGestureListener {
         ...
         * greater than 0.01.
         */
        fun onScale(view: View?, detector: ScaleGestureDetectorKotlin?): Boolean
        ...
        fun onScaleBegin(
            view: View?,
            detector: ScaleGestureDetectorKotlin?
        ): Boolean
         ...
         * retrieve extended info about event state.
         */
        fun onScaleEnd(view: View?, detector: ScaleGestureDetectorKotlin?)
    }
    ...
    private fun setContext(view: View, curr: MotionEvent) {
        ...
        if (prevIndex0 < 0 || prevIndex1 < 0 || currIndex0 < 0 || currIndex1 < 0) {
            ...
            Log.e(
                TAG,
                "Invalid MotionEvent stream detected.",
                Throwable()
            )
            if (isInProgress) {
                mListener.onScaleEnd(view, this)
